...
public class BPlusTreeNodeTests {
    ...
    public void testNodeSize() {
        ...
        Assertions.assertEquals(0, leafNode0.getLeafSize());
        Assertions.assertEquals(1, leafNode1.getLeafSize());
        Assertions.assertEquals(2, leafNode2.getLeafSize());
        ...
        Assertions.assertEquals(0, innerNode0.getLeafSize());
        Assertions.assertEquals(1, innerNode1.getLeafSize());
        Assertions.assertEquals(4, innerNode4.getLeafSize());
